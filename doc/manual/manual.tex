...
\begin{advanced}
\paragraph{Note:} Some of the more detailed portions of this manual have
...
\item[\code{LaTeXML-navbar-right.css}] Places a navigation bar on the right.
...
latexmlpost --format=html5 \
   --javascript='https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/MathJax.js?config=MML_CHTML' \
